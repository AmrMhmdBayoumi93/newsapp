...
//   Future <List<ArticleModel>> getEgyptGeneralNews() async {
//     // this async method return List of obj which called articlesLsit
//     try {
      
//     Response response = await dio.get('https://newsapi.org/v2/top-headlines?country=us&apiKey=be9f4269650845ceac4a9b1218cdc663');
...
//         ArticleModel articleModelObj = ArticleModel(image:article["urlToImage"] ,
//                                  title: article["title"],
